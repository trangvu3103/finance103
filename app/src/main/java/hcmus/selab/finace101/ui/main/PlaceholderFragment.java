...
public class PlaceholderFragment extends Fragment{
    ...
    public View onCreateView(
        ...
        final View rootView = inflater.inflate(R.layout.fragment_wallet,
                container, false);
//        final TextView radioGroup = rootView.findViewById(R.id.recycler_record);
...
//            mRecordAmount_list.addLast(getArguments().getString("AMOUNT"));
...
//    }
    ...
    public void setRecordListener(addRecordListener callback) {
